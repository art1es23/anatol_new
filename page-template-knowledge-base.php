...
/* Template Name: knowledge base */
 get_header(); ?>
<?php get_template_part('template-parts/template-part-big'); ?>
...
<div class="container-fluid">
								...
								while($query->have_posts()) {
									...
									<div class="it-box">
										<div class="it-content">
											<div class="it_header_part <?php if (!empty(get_field('wpcf-video'))) { echo 'has_video'; } ?>">
												<?php if (!empty(get_the_title()) && !empty(get_field('wpcf-companyname'))) {?>
													<a href="<?=get_the_permalink()?>"><?=get_the_title()?></a>, <?=get_field('wpcf-companyname')?>
	...
	<div class="container-fluid full_bottom_container">
		<?php // get_template_part('template-parts/widgets/video-slider'); ?>
