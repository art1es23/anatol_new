	...
	<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
		<thead>
			<tr>
				...
				<th class="product-price td-center"><?php esc_html_e( 'Price', 'woocommerce' ); ?></th>
				<th class="product-quantity td-center"><?php esc_html_e( 'Quantity', 'woocommerce' ); ?></th>
				<th class="product-subtotal td-center"><?php esc_html_e( 'Subtotal', 'woocommerce' ); ?></th>
				<th class="product-remove td-center"><?php esc_html_e( 'Remove', 'woocommerce' ); ?></th>
			</tr>
		</thead>
		<tbody>
			...
			foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
				...
				if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
					...
					<tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
						...
						<?php
						$thumbnail = apply_filters( 'woocommerce_cart_item_thumbnail', $_product->get_image('minithumb'), $cart_item, $cart_item_key, 'minithumb' );
