...
<div
    ...
    <div class="product_content_row">
        <div id="product-<?php the_ID(); ?>" class="single-product">
            <div class="single-product__item single-product__item--left">
                <div class="equipment_thumbnail">
                    <?php do_action( 'woocommerce_before_single_product_summary' ); ?>
                </div>
            </div>

            <div class="single-product__item single-product__item--right">
                <!-- <div class="equipment_right_info product_single_info"> -->
                <?php echo woocommerce_template_single_title(); ?>

                <?php 
                    if ( $product->is_on_sale() ) : 
                        echo apply_filters( 'woocommerce_sale_flash', '<span class="onsales">' . esc_html__( 'Sale!', 'woocommerce' ) . '</span>', $post, $product ); 
                    endif; ?>
                ...
                <ul class="product-attributes">
                    <li class="product-attributes__item">
                        <span class="product-attributes__caption">ID:</span>
                        <span class="product-attributes__data"># <?php the_ID(); ?></span>
                    </li>
                    ...
                    <li class="product-attributes__item">
                        <span class="product-attributes__caption"><?php echo $tax_label; ?>: </span>
                        <?php
                            $tax_terms = array();
                        ...
                        <span class="product-attributes__data"><?php echo implode(', ', $tax_terms); ?></span>
                    </li>

                    <?php } else { $value_string = implode( ', ', $attribute->get_options() ); ?>

                    <li class="product-attributes__item">
                        <span class="product-attributes__caption"><?php echo wc_attribute_label($name); ?>: </span>
                        <span class="product-attributes__data"><?php echo esc_html($value_string); ?></span>
                    </li>
                    <?php }}?>
                </ul>
