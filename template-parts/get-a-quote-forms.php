...
<div class="get_quote innerr hidden">
    ...
    <div id="contact_form_pop" class="form_pop">
        <form id="__vtigerWebForm" name="Get A Quote - VOLT XL" action="" method="post" accept-charset="utf-8"
            ...
            <?php 	
		if (is_single( 2657 )){ //The All-Electric VOLT Series Professional-Grade Electric Automatic Screen Printing Machines
			echo '<input type="hidden" name="__vtrftk" value="sid:128b809fb4a839a088ae98d80e33292b2b9618fe,1614090391">
			<input type="hidden" name="publicid" value="94fcba79d11405ac7d3e2808072562a4">
			<input type="hidden" name="urlencodeenable" value="1">
			<input type="hidden" name="name" value="Get A Quote - VOLT Series">';
		}
		elseif (is_single( 372 )){ //VOLT S Screen Printing Machine
			echo '<input type="hidden" name="WebFormID" value="5e29774dc94cd">';
		}
		elseif (is_single( 5 )){ //VOLT M Screen Printing Machine
			echo '<input type="hidden" name="__vtrftk" value="sid:27cf19b9a1c65613447e500a84babf281e4579b2,1614090496"><input type="hidden" name="publicid" value="e01cff94a7a8741b4cd5de9a30ca00f4"><input type="hidden" name="urlencodeenable" value="1"><input type="hidden" name="name" value="Get A Quote - VOLT M">'; 
		}
		elseif (is_single( 6 )){ //VOLT L Screen Printing Machine
			echo '<input type="hidden" name="__vtrftk" value="sid:a8fd939bafebbea70521d12bb3b28e75d01865f0,1614090160">
			<input type="hidden" name="publicid" value="12c9124dd859b28f6f32d7710e92787a">
			<input type="hidden" name="urlencodeenable" value="1">
			<input type="hidden" name="name" value="Get A Quote - VOLT L">';
		}
		elseif (is_single( 7 )){ //VOLT XL Screen Printing Machine
			echo '<input type="hidden" name="__vtrftk" value="sid:cf545a9506046b63783b77ff362fd26927fa13ce,1614088627">	
	<input type="hidden" name="publicid" value="a3b537df0b0876bcef810a5ad49a7ce4"><input type="hidden" name="urlencodeenable" value="1">
	<input type="hidden" name="name" value="Get A Quote - VOLT XL">';
		}
		elseif (is_single( 262 )){//VECTOR Series Automatic Screen Printing Machines	
			echo '<input type="hidden" name="__vtrftk" value="sid:f2bc76498b9e3d8a7c54ec10698a9dd69effde97,1614090902"><input type="hidden" name="publicid" value="13cad8c1605f8381feae46afc998b3f5"><input type="hidden" name="urlencodeenable" value="1"><input type="hidden" name="name" value="Get A Quote - VECTOR Series">';
		}
		elseif (is_single( 265 )){	//VECTOR S Screen Printing Machine
			echo '<input type="hidden" name="__vtrftk" value="sid:b3931c53ab5d1571d9e29cfe6b166973ea8124d7,1614090926"><input type="hidden" name="publicid" value="1e7b2f59bb12dbb4af09444ff17deac7"><input type="hidden" name="urlencodeenable" value="1"><input type="hidden" name="name" value="Get A Quote - VECTOR S">';
		}
		elseif (is_single( 267 )){	//VECTOR M Screen Printing Machine
			echo '<input type="hidden" name="__vtrftk" value="sid:e2287d08da6434688e9934b3ff903f9f75f2d5da,1614090946"><input type="hidden" name="publicid" value="cfcc58066c1053cfc79b213ed8ba8717"><input type="hidden" name="urlencodeenable" value="1"><input type="hidden" name="name" value="Get A Quote - VECTOR M">';
		}
		elseif (is_single( 269 )){	//VECTOR L Screen Printing Machine
			echo '<input type="hidden" name="__vtrftk" value="sid:20de29a23a9d7a7db82d95ad989bf4841929ba35,1614090974"><input type="hidden" name="publicid" value="f46c5a35d2e89c2b708a6e36604ebb1d"><input type="hidden" name="urlencodeenable" value="1"><input type="hidden" name="name" value="Get A Quote - VECTOR L">';
		}
		elseif (is_single( 270 )){	//VECTOR XL Screen Printing Machine
			echo '<input type="hidden" name="__vtrftk" value="sid:7c61c00ffc6610d44ed8b296a3cb9542d51ba188,1614090996"><input type="hidden" name="publicid" value="77ef9cc82e0a604d35a3bb411a147262"><input type="hidden" name="urlencodeenable" value="1"><input type="hidden" name="name" value="Get A Quote - VECTOR XL">';
		}
		elseif (is_single( 13 )){	//Automatic TITAN Series — Small but Mighty, with Big Time Features
			echo '<input type="hidden" name="__vtrftk" value="sid:d6e00c91b61dde17a6159257c33db46da3abf140,1614091020"><input type="hidden" name="publicid" value="12343b24edf6361eacdf55a504bdd0d1"><input type="hidden" name="urlencodeenable" value="1"><input type="hidden" name="name" value="Get A Quote - Automatic TITAN Series">';
		}
		elseif (is_single( 234 )){	//TITAN M Automatic Screen Printing Machine
			echo '<input type="hidden" name="__vtrftk" value="sid:d2e9b6d7b0050e385f1346fbf5275e928f25cb7b,1614091041"><input type="hidden" name="publicid" value="3af6c1f04984267ef771f0cb6e939c10"><input type="hidden" name="urlencodeenable" value="1"><input type="hidden" name="name" value="Get A Quote - TITAN M">';
		}
		elseif (is_single( 232 )){	//TITAN S Automatic Screen Printing Machine
			echo '<input type="hidden" name="__vtrftk" value="sid:0c0c8f0b8ad22a5042a10856cced5fe805ba8ed5,1614091064"><input type="hidden" name="publicid" value="0a67e8a8a704f9e73275e242f326b657"><input type="hidden" name="urlencodeenable" value="1"><input type="hidden" name="name" value="Get A Quote - TITAN S">';
		}
		elseif (is_single( 21 )){	//Color Magic One Color Flatbed Press
			echo '<input type="hidden" name="__vtrftk" value="sid:f95d0baa4207e502ae68240578197504dbb4dfc7,1614091090"><input type="hidden" name="publicid" value="b29158517e9ac0abb4e2444ff45fba29"><input type="hidden" name="urlencodeenable" value="1"><input type="hidden" name="name" value="Get A Quote - Color Magic One Color Flatbed Press">';
		}
		elseif (is_single( 20 )){	//Automatic Heat Transfer Press
			echo '<input type="hidden" name="__vtrftk" value="sid:735b02a3071f41f3e430a615c79c4ab49acf8ef7,1614091117"><input type="hidden" name="publicid" value="06b79efff55ef5d4ec12a57ff6b491d0"><input type="hidden" name="urlencodeenable" value="1"><input type="hidden" name="name" value="Get A Quote - Automatic Heat Transfer Press">';
		}
		elseif (is_single( 16 )){	//Prodigy Small Format Screen Printing Press
			echo '<input type="hidden" name="__vtrftk" value="sid:1aee93a78bb62b1d7f282e716098bc7f6f5af9f8,1614091190"><input type="hidden" name="publicid" value="3243d783c085ae44dc33bba84b7ec852"><input type="hidden" name="urlencodeenable" value="1"><input type="hidden" name="name" value="Get A Quote - Prodigy Small Format Screen Printing Press">';
		}
		elseif (is_single( 20 )){	//Thunder Manual Screen Printing Press
			echo '<input type="hidden" name="__vtrftk" value="sid:c3e131ac76f8fb5dc6d8857918162f78e6d5fdcc,1614091289"><input type="hidden" name="publicid" value="c0df814a309e6d05e2a840d3f49d35f4"><input type="hidden" name="urlencodeenable" value="1"><input type="hidden" name="name" value="Get A Quote - Thunder Manual Screen Printing Press">';
		}
		elseif (is_single( 8525 )){	//Lightning Manual Screen Printing Press
			echo '<input type="hidden" name="__vtrftk" value="sid:d44d0714516195c2b8bf14c774ce67d95fd34fc2,1614091326"><input type="hidden" name="publicid" value="f64ec6b15cc00733a9a23174e8178bae"><input type="hidden" name="urlencodeenable" value="1"><input type="hidden" name="name" value="Get A Quote - Lightning Manual Screen Printing Press">';
		}
		elseif (is_single( 23 )){	//Vulcan Gas Dryer
			echo '<input type="hidden" name="__vtrftk" value="sid:e3434204adcd075af2c2f2e41022ec0e13b8731d,1614091348"><input type="hidden" name="publicid" value="21b366228c89c01c8b412919077427d4"><input type="hidden" name="urlencodeenable" value="1"><input type="hidden" name="name" value="Get A Quote - Vulcan Series Gas Conveyor Dryers">';
		}
		
						elseif (is_single( 24 )){	//Vulcan II Modular Gas Dryer
							echo '<input type="hidden" name="__vtrftk" value="sid:e3434204adcd075af2c2f2e41022ec0e13b8731d,1614091348"><input type="hidden" name="publicid" value="21b366228c89c01c8b412919077427d4"><input type="hidden" name="urlencodeenable" value="1"><input type="hidden" name="name" value="Get A Quote - Vulcan Series Gas Conveyor Dryers">';
						}
						
						
						
		elseif (is_single( 22 )){	//Solutions Electric Dryer
			echo '<input type="hidden" name="__vtrftk" value="sid:b60dcaf3bf7ad81f17e0becefac2bc672fd3e1a9,1614091384"><input type="hidden" name="publicid" value="d440f2232f5a6c3a73562464d3777c88"><input type="hidden" name="urlencodeenable" value="1"><input type="hidden" name="name" value="Get A Quote - Solutions Electric Dryer">';
		}
		elseif (is_single( 16574 )){	//Ultra Electric Dryer
			echo '<input type="hidden" name="__vtrftk" value="sid:01c217b2d79fc4c26ca429382d9303898f661bda,1614091400"><input type="hidden" name="publicid" value="f35b78e0afa5622177eefe21ab62698c"><input type="hidden" name="urlencodeenable" value="1"><input type="hidden" name="name" value="Get A Quote - Ultra Electric Dryer">';
		}
		elseif (is_single( 18886 )){ //Comet Light Flash Cure Unit
			echo '<input type="hidden" name="__vtrftk" value="sid:244963694062e2bbc54103420e27ee0c9c5ffc29,1614091427"><input type="hidden" name="publicid" value="ab310691da1154a08ed6826454bbe900"><input type="hidden" name="urlencodeenable" value="1"><input type="hidden" name="name" value="Get A Quote - Comet Light Flash Cure Unit">';
		}
		elseif (is_single( 17878 )){ //COMET PRIME FLASH CURE UNIT	
			echo '<input type="hidden" name="__vtrftk" value="sid:b49e8fcbf724da08092ce725749f36fdc1a24a4e,1614091532"><input type="hidden" name="publicid" value="0f380753e0c6a0363a0beccca9e91e2c"><input type="hidden" name="urlencodeenable" value="1"><input type="hidden" name="name" value="Get A Quote - COMET PRIME FLASH CURE UNIT">';
		}
		elseif (is_single( 29 )){ //Pilot Flash Cure Unit	
			echo '<input type="hidden" name="__vtrftk" value="sid:dfca9a3f1a74160aeb0f2931d69c71320f5bfc88,1614091603"><input type="hidden" name="publicid" value="732ee9db8ec55d7656a79b060f8994cb"><input type="hidden" name="urlencodeenable" value="1"><input type="hidden" name="name" value="Get A Quote - Pilot Flash Cure Unit">';
		}
		elseif (is_single( 28 )){ //Rapid Wave Flash Cure Unit	
			echo '<input type="hidden" name="__vtrftk" value="sid:b862e9c2f23682dec61040b8c9d8b9dcf8c38378,1614092215"><input type="hidden" name="publicid" value="b0b434fcbe2e955ea81300f73d05c43b"><input type="hidden" name="urlencodeenable" value="1"><input type="hidden" name="name" value="Get A Quote - Rapid Wave Flash Cure Unit">';
		}
		
		elseif (is_single( 17903 )){	//Quik-Kote
			echo ' <input type="hidden" name="__vtrftk" value="sid:2ffd34f2fbd187c414a5b8b7b1749ecaf4a0da74,1614092263"><input type="hidden" name="publicid" value="2321e59f291d9518bb40d4f914288410"><input type="hidden" name="urlencodeenable" value="1"><input type="hidden" name="name" value="Get A Quote - Quik-Kote">';
		}
		elseif (is_single( 17449 )){	//Cube - Screen Drying Cabinet
			echo '<input type="hidden" name="__vtrftk" value="sid:9da500fd9241e96b40312cc11a26ecb54c64f1ef,1614092284"><input type="hidden" name="publicid" value="9344a1dac03cce42c63aed6f4e9737a0"><input type="hidden" name="urlencodeenable" value="1"><input type="hidden" name="name" value="Get A Quote - Cube – Screen Drying Cabinet">';
		}
		
		elseif (is_single( 7947 )){	//ARME: Anatol Registration Made Easy
			echo '<input type="hidden" name="__vtrftk" value="sid:9c82a9a9e9251bf494c962488d0e507d184079fe,1614092304"><input type="hidden" name="publicid" value="d312fe0705e1f7d181e7a028eb7d00a5"><input type="hidden" name="urlencodeenable" value="1"><input type="hidden" name="name" value="Get A Quote - ARME: Anatol Registration Made Easy">';
		}
		elseif (is_single( 34 )){	//Aurora UV LED Exposure Unit
			echo '<input type="hidden" name="__vtrftk" value="sid:977a1e4a642500c1c00e73f217b6cffcb742104d,1614092322"><input type="hidden" name="publicid" value="1cbc3a81dbe170e344df105b5a8e51dd"><input type="hidden" name="urlencodeenable" value="1"><input type="hidden" name="name" value="Get A Quote - Aurora UV LED Exposure Unit">';
		}
		elseif (is_single( 18001 )){	//Screen Printing Washout Boothr
			echo '<input type="hidden" name="__vtrftk" value="sid:146a3c7653a2dfbb0c732eec458beba2fffa6a19,1614092361"><input type="hidden" name="publicid" value="e96486046231feac89b54a2c6eabec4a"><input type="hidden" name="urlencodeenable" value="1"><input type="hidden" name="name" value="Get A Quote - Screen Printing Washout Booth">';
		}
		elseif (is_single( 31 )){	//Screen Printing Screen Stretcher
			echo '<input type="hidden" name="__vtrftk" value="sid:8510cfe6ea838e826e559cf49296df868fcae3d6,1614092383"><input type="hidden" name="publicid" value="4caf69ce4c95462d148c0221456d6b3c"><input type="hidden" name="urlencodeenable" value="1"><input type="hidden" name="name" value="Get A Quote - Screen Printing Screen Stretcher">';
		}
		elseif (is_single( 30 )){	//Formulator Screen Printing Ink Mixer
			echo '<input type="hidden" name="__vtrftk" value="sid:19de92dac9d20b89354254372eb9da31f7433f9b,1614092994"><input type="hidden" name="publicid" value="71f4df933dd3bc804b119e392d4f1fd4"><input type="hidden" name="urlencodeenable" value="1"><input type="hidden" name="name" value="Get A Quote - Formulator Screen Printing Ink Mixer">';
		}
		elseif (is_single( 18848 )){	//Big Forge – In-line Heat Press
			echo '<input type="hidden" name="__vtrftk" value="sid:8e59488a2319ca355c66cc314e9f9fd2b7280d37,1614093020"><input type="hidden" name="publicid" value="44c8bf4f2092d09d386ad5d3ed1b844c"><input type="hidden" name="urlencodeenable" value="1"><input type="hidden" name="name" value="Get A Quote - Big Forge – In-line Heat Press">';
		}
		elseif (is_single( 18832 )){	//Mobile Forge In-line Heat Press
			echo '<input type="hidden" name="__vtrftk" value="sid:b5e6fb48cc0cdd2b9441976de19cd9f6ca7c43c5,1614093035"><input type="hidden" name="publicid" value="6e551b3dda8cb188e8ba3866c4a91b0a"><input type="hidden" name="urlencodeenable" value="1"><input type="hidden" name="name" value="Get A Quote - Mobile Forge In-line Heat Press">';
		}
		elseif (is_single( 17933 )){	//Cooling Fan
			echo '<input type="hidden" name="__vtrftk" value="sid:47a7fd838d6272762fb7f8a4774375e266fea519,1614093131"><input type="hidden" name="publicid" value="0d5f639c22c55994dfdcd82c7f7d7564"><input type="hidden" name="urlencodeenable" value="1"><input type="hidden" name="name" value="Get A Quote - Cooling Fan">';
		}
		elseif (is_single( 18811 )){	//Roller Squeegee
			echo '<input type="hidden" name="__vtrftk" value="sid:abc42d9e11f0abce621b4ce6f47fdf1c3e6d89ca,1614093180"><input type="hidden" name="publicid" value="93f82a2d79516d709b16d2c58ae0babc"><input type="hidden" name="urlencodeenable" value="1"><input type="hidden" name="name" value="Get A Quote - Roller Squeegee">';
		}
		elseif (is_single( 368 )){	//Screen Printing Press Squeegees
			echo '<input type="hidden" name="__vtrftk" value="sid:727d6c195be5d794faeedb239c6f837a3f010ed6,1614093238"><input type="hidden" name="publicid" value="11a1463d081823b5c84efa7880f9f54c"><input type="hidden" name="urlencodeenable" value="1"><input type="hidden" name="name" value="Get A Quote - Screen Printing Press Squeegees">';
		}
		elseif (is_single( 15727 )){	//24-Capacity Screen Rack
			echo '<input type="hidden" name="__vtrftk" value="sid:06ccf10654e97016d916b72b455501fe6e956de4,1614093253"><input type="hidden" name="publicid" value="bf658a31200c8560db6441cbafef5625"><input type="hidden" name="urlencodeenable" value="1"><input type="hidden" name="name" value="Get A Quote - Aluminum 25-Capacity Screen Rack	">';
		}
		elseif (is_single( 38 )){	//Flood Bars for Screen Printing Machines
			echo '<input type="hidden" name="__vtrftk" value="sid:9913c1ae4279348d7074aad040d583c045a9c0eb,1614093323"><input type="hidden" name="publicid" value="c8a55ccab69da9914193b568dd936ff3"><input type="hidden" name="urlencodeenable" value="1"><input type="hidden" name="name" value="Get A Quote - Flood Bars for Screen Printing Machines">';
		}
		elseif (is_single( 36 )){	//Flocking Machine
			echo '<input type="hidden" name="__vtrftk" value="sid:c9a10285186347f6e2dddde3d49254619b84cc3d,1614093341"><input type="hidden" name="publicid" value="aba4d35b0c45dbb074f8cad6b16e48b6"><input type="hidden" name="urlencodeenable" value="1"><input type="hidden" name="name" value="Get A Quote - Flocking Machine">';
		}
		elseif (is_single( 37 )){	//Screen Printing Press Pallets
			echo '<input type="hidden" name="__vtrftk" value="sid:86f9332abed8038ad127bc23c36c9e11bd92407d,1614093546"><input type="hidden" name="publicid" value="d73b486f5534492978f06722a153b4ee"><input type="hidden" name="urlencodeenable" value="1"><input type="hidden" name="name" value="Get A Quote - Screen Printing Press Pallets">';
		}
		else {	
			echo '<input type="hidden" name="__vtrftk" value="sid:117320670c26be7435a870e1421555aa92ad29f6,1614093617"><input type="hidden" name="publicid" value="0aee4eda12acdaf163860fd64d6841da"><input type="hidden" name="urlencodeenable" value="1"><input type="hidden" name="name" value="Get a quote on the equipment page">';
		} 
	?>
            ...
            <div class="form-row">
                <div class="field_full">
                    <label> What equipment are you interested in?</label>
                    <input type="text" name="cf_1075" value="<?php the_title();?>"
                        placeholder="What equipment are you interested in?*" required>
                </div>
            </div>
            <div class="form-row">
                <div class="field_full">
            ...
            <div class="form-row text-center">
                <input id="my_form_send" type="submit" name="submit_web_form" value="Get a Quote"
