                ...
                <div class="col-md-12">
					...
					if(have_rows('regional_offices_repeater', 'option')) {
						...
						while (have_rows('regional_offices_repeater', 'option')){
							...
							?>
                    <div class="col-md-4 regional_office_item" data-aos="fade-down">
                        ...
                        <div class="bg_content_part">
                            ...
                            <div class="social_part">
                                ...
                                <?PHP } ?>
                                <?PHP if(!empty(get_sub_field('rss'))) { ?><a href="<?PHP echo get_sub_field('rss'); ?>"
                                    target="_blank" class="item_rss"><i class="wicon-rss"></i></a>
                                <?PHP } ?>
                            </div>
                        </div>
                    </div>
