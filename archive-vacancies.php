...
<!-- <div id="main-content">
	<div class="entry-content"> -->
		...
		?>
		<div <?php if ($image_info) { echo 'class="head_section white_shadow has_background" style="background-image:url('.$hero_url[0].')"'; } else { echo 'class="head_section contacts_head"'; } ?> >
			<div class="container">
...
<div class="container dmbs-container vacancy_content">
  ...
  <div class="row dmbs-content">
    <div class="col-md-12 dmbs-main">
      ...
      <div class="vacancy_contact_us"><a data-fancybox data-src="#vacancy_contact_us_hidden" href="javascript:;" class="button"><?php _e('сontact us'); ?></a></div>
  ...
  <?php if(!have_posts()) {?>
    <div class="col-md-12 dmbs-main">
      ...
      echo sprintf(__('Sorry, we don`t have a vacancy %s %s now but you can send your CV we will contact you in the future.'), $position, $country); ?></center></p>
    </div>
