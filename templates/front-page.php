<?PHP
/* Template Name: Home Page NEW NEW NEW NEW*/
...
<div class="main">
        ...
        <div class="choose-us--wrapper container">
            ...
            <div class="choose-us__item choose-us__item--right choose-us__img">
                <img loading="lazy" class="lozad logo-img site-logo-img"
                    src="<?php bloginfo('template_directory'); ?>/assets/images/anatol-flag.png"
                    alt="Anatol official flag" width="583" height="auto">
            </div>
        </div>
    </section>
    ...
    <section class="dashboard-section">
        <div class="dashboard__item latest-blogs">
            <div class="dashboard__head">
                ...
                <p class="dashboard__pretitle"><?php echo $blog_section_description; ?></p>
                <?php }	?>
            </div>
        ...
        <div class="dashboard__item testimonials">
            ...
            <div class="feedbacks-list">
                ...
                <div class="feedback-post--wrapper">
                    <span class="svg-wrapper svg-quote"></span>
                    <div class="feedbacks-list__item feedback-post">
                        <h3 class="feedback-post__caption"><?php echo get_field('customer_company'); ?></h3>
                        <p class="feedback-post__excerpt"><?php echo get_field('short_review'); ?></p>
                    </div>
                </div>
    ...
    <section id="video_bg" class="home-footer-video">
        <video loading="lazy" id="videobcg" preload="auto" autoplay="true" loop="loop" muted="muted" volume="0">
            <source src="<?php bloginfo('template_directory'); ?>/assets/images/video/volt_intro_compress.mp4"
                type="video/mp4">
        </video>
