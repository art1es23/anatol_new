<style>
<?php include locate_template('css/page-templates/page-contact/components/contact-form.css');
?>
</style>

<div class="contact-us__item contact-us-form form">
    <h2 class="form-title contact-us-form__title"><?php _e('Send A Message', 'anatol'); ?></h2>
    ...
    <form id="__vtigerWebForm" autocomplete="off" class="form-inner contactForm1 get_forms contact_get_forms"
        ...
        <div class="form-inner__item">
            <div class="form-inner__item--half">
                ...
                <input type="text" class="clear_form" name="firstname"
        ...
        <div class="form-inner__item">
            <div class="form-inner__item--full">
                ...
                <input type="text" class="clear_form" name="company"
        ...
        <div class="form-inner__item">
            <div class="form-inner__item--full">
                ...
                <select name="cf_1085" class="clear_form" onchange="yesnoCheckCon(this);" required>
                    ...
                    <option class="elements" value="Congo, The Democratic Republic of The">Congo, The
                        Democratic Republic
                        of The</option>
                    ...
                    <option class="elements" value="Heard Island and Mcdonald Islands">Heard Island and
                        Mcdonald Islands
                    </option>
                    <option class="elements" value="Holy See (Vatican City State)">Holy See (Vatican City
                        State)</option>
