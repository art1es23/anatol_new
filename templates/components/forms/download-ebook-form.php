<div class="form-download-ebook form hidden">
    ...
    <h3 class="form-title">Download eBook</h3>

    <form id="__vtigerWebForm" class="form-inner contactFormEbook get_forms" name="Download our free white paper"
        ...
        <div class="form-inner__item">
            <div class="form-inner__item--full">
                ...
                <input type="text" name="description" value="<?php the_title();?>" placeholder="Download eBook*"
                    required>
            </div>
        </div>
