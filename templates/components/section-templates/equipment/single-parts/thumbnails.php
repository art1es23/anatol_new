...
<div id="image-carousel-container" class="image-carousel-container swiper" data-lazy-load="true">
    <div class="equipment_gallery swiper-wrapper" data-lazy-load="true">
        ...
        <a class="gallery-item swiper-slide" href="<?php echo $g_image[0]; ?>"
            title="<?php echo esc_attr($gallery_image['caption']); ?>">
            <picture class="main_gallery_image">
                <source srcset="<?php echo $g_image[0]; ?>" type="image/webp">
                <img class="swiper-lazy" src="<?php echo $g_image[0]; ?>"
