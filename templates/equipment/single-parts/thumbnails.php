...
<a class="gallery-item swiper-slide" href="<?php echo $g_image[0]; ?>" data-fancybox="product-images"
    ...
    <picture class="main_gallery_image">
        ...
        <img src="<?php echo $g_image[0]; ?>" alt="<?php echo esc_attr($gallery_image['alt']); ?>"
            width="<?php echo $g_image[1]; ?>" height="<?php echo $g_image[2]; ?>">
    </picture>
</a>
...
<div class="item-thumbnail">
    <div class="ico-thumbnail">
        <img src="<?php echo $th_image[0]; ?>" loading="lazy" class="lozad main_gallery_image"
            alt="<?php echo esc_attr($gallery_image['alt']); ?>" width="1362" height="969">
    </div>
</div>
<?php
    $slider_data['slides'][] = array(
