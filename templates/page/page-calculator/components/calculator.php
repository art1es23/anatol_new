        ...
        <form id="__vtigerWebForm" class="form-inner register-form get_forms step-container" name="register-form" action
            ...
            <div class="form-inner__item">
                <div class="form-inner__item--half" id="Enterfirstname">
                    ...
                    <input type="text" class="formData-field form-control" name="firstname" id="inputName"
                ...
                <div class="form-inner__item--half" id="Enterlastname">
                    ...
                    <input type="text" class="formData-field form-control" name="lastname" id="inputLastName"
            ...
            <div class="form-inner__item">
                <div class="form-inner__item--full">
                    ...
                    <input type="email" class="formData-field form-control" name="email" id="inputEmail"
            ...
            <div class="form-inner__item">
                <div class="form-inner__item--full">
                    ...
                    <select id="inputCountry" class="formData-field chosen-select form-control" name="cf_1085"
            ...
            <div id="ifYesRoi" class="form-inner__item" style="display: none;">
                <div class="form-inner__item--full">
                    ...
                    <select id="state_required" class="formData-field chosen-select form-control invalid error"
                        name="cf_1093">
    ...
    <div class="form calculation step first_form_active">
        ...
        <form class="form-inner calculation-form calculator-form step-container get_forms" name="calculation-form"
            ...
            <div class="form-inner__item">
                ...
                <div class="form-inner__item--full">
                    <input type="number" min="0" step="1" value="" class="formData-field form-control" name="fronts"
                        id="fronts" placeholder="<?php _e('Fronts', 'anatol'); ?>" required>
                </div>
                <div class="form-inner__item--full">
                    <input type="number" min="0" step="1" value="" class="formData-field form-control" name="backs"
                        id="backs" placeholder="<?php _e('Backs', 'anatol'); ?>" required>
                </div>
            </div>
            <div class="form-inner__item">
                ...
                <div class="form-inner__item--half">
                    <input type="number" min="1" step="1" value="" class="formData-field form-control"
                        name="shirtsPerHour" id="shirtsPerHour" placeholder="" required>
                </div>
            </div>
            <div class="form-inner__item">
                <div class="form-inner__item--half">
                ...
                <div class="form-inner__item--half">
                    <input type="number" min="1" step="1" value="" class="formData-field form-control"
                        name="printersPerPress" id="printersPerPress" placeholder="" required>
                </div>
            </div>
            <div class="form-inner__item">
                <div class="form-inner__item--half">
                ...
                <div class="form-inner__item--half">
                    <input type="number" min="1" step="any" value="" class="formData-field form-control"
                        name="printerPerHour" id="printerPerHour" placeholder="" required>
                </div>
            </div>
            <div class="form-inner__item">
                ...
                <div id="completion-time" class="card preload">
                    ...
                    <div class="card-body">
                        <div class="row row-flex">
                            <div class="col-xs-6">
                                ...
                                <div class="manual value">
                                    <span data-value="manual" class="val"></span>
                                    <span class="hours">
                                        <?php _e('hrs', 'anatol'); ?>
                                    </span>
                                </div>
                            ...
                            <div class="col-xs-6">
                                ...
                                <div class="automatic value">
                                    <span data-value="automatic" class="val"></span>
                                    <span class="hours">
                                        <?php _e('hrs', 'anatol'); ?>
                                    </span>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="field_full">
                                <div class="total">
                                    <span data-value="total" class="val"></span>
                                    <span class="hours">
                                        <?php _e('hours', 'anatol'); ?>
                                    </span>
                                </div>
                        ...
                        <div class="row row-flex">
                            <div class="col-xs-6">
                                ...
                                <div class="value manual">
                                    <span data-value="manual" class="manual val"></span>
