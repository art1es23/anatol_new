...
<div class="profiles-list">
  ...
  while( $query->have_posts()):
    ...
    ?>
    <div class="profile-list__item profile" data-continent="<?php echo join( ',', $regions ); ?>"
        data-country="<?php echo join(',', $data_country ); ?>">
        <div class="profile__thumbnail--wrapper">
            ...
            <div class="employeer-info">
                ...
                <?php } ?>
                <a class="button quote-button get_a_quote" href="#"><?php _e('Get a Quote', ''); ?></a>
            </div>
        </div>
