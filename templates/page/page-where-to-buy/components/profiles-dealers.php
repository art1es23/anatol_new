...
<div class="profiles-list">
  ...
  while( $query->have_posts()):
    ...
    ?>
    <div class="profile-list__item dealer-item" data-continent="<?php echo join( ',', $regions ); ?>"
        ...
        <div class="contacts-list">
            ...
            <div class="website">
                <i class="fa fa-globe"></i><a href="<?php echo get_field('website'); ?>"
                    target="_blank"><?php echo get_field('website'); ?></a>
            </div>
            <?php } ?>
            <?php if(get_field('website_2')){ ?>
            <div class="website">
                <i class="fa fa-globe"></i><a href="<?php echo get_field('website_2'); ?>"
                    target="_blank"><?php echo get_field('website_2'); ?></a>
            </div>
            <?php } ?>
            ...
            <div class="skype">
                <i class="fa fa-skype"></i><a
                    href="skype:<?php echo get_field('skype'); ?>?call"><?php echo get_field('skype'); ?></a>
            </div>
            <?php } ?>
