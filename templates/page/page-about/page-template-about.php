...
include local_template('css/components/contact-support.css');
include local_template('css/components/about-description.css');
include local_template('css/page-templates/page-about/business-opportunities.css');
include local_template('css/page-templates/page-about/anatol-map.css');
?>
</style>
...
<section class="business-opportunities">
    ...
    <!-- <div class="business-img" style="background-image:url('<?php bloginfo('template_directory'); ?>/assets/images/image/business.jpg');"></div> -->
