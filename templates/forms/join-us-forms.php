<div class="join_us_form innerr">
    ...
    <div class="form-title">Become a dealer</div>
    <div id="contact_form_pop" class="form_pop">
        <form id="__vtigerWebForm" name="Get A Quote - VOLT XL" action="" method="post"
            ...
            <div id="ifYess" class="form-row " style="display: none;">
                <div class="field_full">
