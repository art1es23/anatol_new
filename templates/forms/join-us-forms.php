<div class="join_us_form form hidden">
    ...
    <!-- <div id="contact_form_pop" class="form-inner form_pop"> -->
    <form id="__vtigerWebForm2" name="Get A Quote - VOLT XL" action="" method="post"
        action="https://sale.anatol.com/modules/Webforms/capture.php" accept-charset="utf-8"
        ...
        <input type="hidden" name="name" value="Get a quote on the equipment page">



        <input type="text" name="cf_979" value="Become a dealer" style="display:none;">
        ...
        <div class="form-inner__item">
            <div class="form-inner__item--full">
                ...
                <select name="cf_1085" onchange="yesnoChecks(this);" required>
        ...
        <div id="ifYess" class="form-inner__item " style="display: none;">
            <div class="form-inner__item--full">
