<div class="get_quote innerr">
    <a class="close_pop" style="float: right;"><img loading="lazy" class="lozad src="
            <?php bloginfo('template_directory'); ?>/images/close.svg" style="width: 20px" alt=""></a>
    <div class="form-title"><?php _e('Get a Quote', 'anatol'); ?></div>
    <div id="contact_form_pop" class="form_pop">
        ...
        <form id="__vtigerWebForm" name="Get A Quote - VOLT XL" action="" method="post" accept-charset="utf-8"
            ...
            <?php  if ( is_singular( 'anatol-products-pres' ) ) : ?>
            <div class="form-row">
                <div class="field_full">
                    <label> What equipment are you interested in?</label>
                    <input type="text" name="cf_1075" value="<?php the_title();?>"
                        placeholder="<?php _e('What equipment are you interested in?', 'anatol'); ?>*" required>
                </div>
            </div>
            <?php else : ?>
            <div class="form-row">
