...
<form id="__vtigerWebForm" class="contactFormEbook get_forms" name="Download our free white paper" action="https://sale.anatol.com/modules/Webforms/capture.php" method="post" accept-charset="utf-8" enctype="multipart/form-data">
<input type="hidden" name="__vtrftk" value="sid:d277a67b9be858170f33029fca99a96bb5948fd9,1614692039">
<input type="hidden" name="publicid" value="e2d01c2534e67c1a0c5af0c50951a29a">
<input type="hidden" name="urlencodeenable" value="1">
<input type="hidden" name="name" value="Download our free white paper">
	
		<input type="text" name="cf_979" value="Download eBook" style="display:none;">
        ...
        <div class="form-row">
			<div class="half">
                ...
                <input type="tel" name="phone" placeholder="<?php _e('Phone Number', 'anatol'); ?>*" maxlength="18" id="tel">
			</div>
			<div class="half">
		...
		<div class="form-row">
	        <div class="field_full">
                <label>Download eBook</label>
                <input type="text" name="description" value="<?php the_title();?>" placeholder="Download eBook*" required>
			</div>	
        </div>	
		
        <div class="form-row text-center">
			<input type="submit" name="submit_web_form" value="Download eBook" class="button">
        </div>
