	...
	<div class="get_in_touch_cont">
		...
		<div class="anim_left">
			<div class="contact_line ">
				<div class="get_in_title"><h2>Get In Touch</h2></div>
			</div>
			<div class="get_contacts_slider sldots">
				...
				<div class="left_column cont_datas">
					...
					<div class="contact_line ">
						<div class="">
						<h4 class="contact_line_header"><span class="cont_ico ico_location"></span><span>Location</span></h4>
				...
				Lake Bluff, IL 60044, USA</div>
					...
					<div class="contact_line">
						<div class="">
							<h4 class="contact_line_header"><span class="cont_ico ico_phone"></span><span>Phone</span></h4>
