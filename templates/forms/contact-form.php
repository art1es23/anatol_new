...
<form id="__vtigerWebForm" autocomplete="off" class="contactForm1 get_forms contact_get_forms" action="https://sale.anatol.com/modules/Webforms/capture.php" name="Contact Form" action="" method="post" accept-charset="utf-8"  enctype="multipart/form-data">
<input type="hidden" name="__vtrftk" value="sid:a664688c984a3ea3a911bd1a3330d917e1eb128b,1647247687">
<input type="hidden" name="publicid" value="0875315a5d5e21c80eba960461a4171c">
...
<input type="hidden" name="name" value="Contact Us Form">
        ...
        <div class="form-row">
			<div class="half">
					...
					<input type="text" class="clear_form"    name="firstname" placeholder="<?php _e('First Name', 'anatol'); ?>*" required>				
			</div>
			<div class="half">
					<label><?php _e('Last Name', 'anatol'); ?><span class="field_required">*</span></label>			
					<input type="text" class="clear_form"  name="lastname" placeholder="<?php _e('Last Name', 'anatol'); ?>*" required>				
			</div>
		</div>
        <div class="form-row">
        ...
        <div class="form-row">
			<div class="half">
                ...
                <input type="tel" class="clear_form"  name="phone" placeholder="<?php _e('Phone Number', 'anatol'); ?>*" maxlength="18" id="tel">
			</div>
			<div class="half">
                <label><?php _e('Email', 'anatol'); ?><span class="field_required"></span></label>
                <input type="Email" class="clear_form"  name="email" placeholder="<?php _e('Email', 'anatol'); ?>*" required>
			</div>
        </div>
		...
		<div class="form-row">
			<div class="field_full">
				...
				<select name="cf_1085" class="clear_form" onchange="yesnoCheckCon(this);" required> 
					<option class="choose_elements" value="" selected="selected"><?php _e('Select Country', 'anatol'); ?>*</option> 
					...
					<option class="elements" value="British Indian Ocean Territory">British Indian Ocean Territory</option> 
					...
					<option class="elements" value="Congo, The Democratic Republic of The">Congo, The Democratic Republic of The</option> 
					...
					<option class="elements" value="Falkland Islands (Malvinas)">Falkland Islands (Malvinas)</option> 
					...
					<option class="elements" value="French Southern Territories">French Southern Territories</option> 
					...
					<option class="elements" value="Heard Island and Mcdonald Islands">Heard Island and Mcdonald Islands</option> 
					<option class="elements" value="Holy See (Vatican City State)">Holy See (Vatican City State)</option> 
					...
					<option class="elements" value="Korea, Democratic People's Republic of">Korea, Democratic People's Republic of</option> 
					...
					<option class="elements" value="Lao People's Democratic Republic">Lao People's Democratic Republic</option> 
					...
					<option class="elements" value="Micronesia, Federated States of">Micronesia, Federated States of</option> 
					...
					<option class="elements" value="Palestinian Territory, Occupied">Palestinian Territory, Occupied</option> 
					...
					<option class="elements" value="Saint Vincent and The Grenadines">Saint Vincent and The Grenadines</option> 
					...
					<option class="elements" value="South Georgia and The South Sandwich Islands">South Georgia and The South Sandwich Islands</option> 
					...
					<option class="elements" value="Tanzania, United Republic of">Tanzania, United Republic of</option> 
					...
					<option class="elements" value="United Kingdom">United Kingdom</option> 
					<option class="elements" value="United States">United States</option> 
					<option class="elements" value="United States Minor Outlying Islands">United States Minor Outlying Islands</option> 
		...
		<div id="ifYesCon" class="form-row" style="display: none;">
			...
			<label for="state_required">State/Region<span class="form-required">*</span></label>
				<select id="state_required" class="clear_form"  class="invalid error" name="cf_1093" >
					...
					<option class="canadian_province elements" value="Newfoundland and Labrador">Newfoundland and Labrador</option>
					<option class="canadian_province elements" value="Northwest Territories">Northwest Territories</option>
					...
					<option class="canadian_province elements" value="Prince Edward Island">Prince Edward Island</option>
		...
		<div class="form-row">
	        <div class="field_full">
				...
				<textarea class="clear_form" name="description" placeholder="<?php _e('Your message', 'anatol'); ?>"></textarea>
			</div>	
        </div>
