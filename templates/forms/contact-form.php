	<form id="__vtigerWebForm" autocomplete="off" class="form-inner contactForm1 get_forms contact_get_forms"
	    action="https://sale.anatol.com/modules/Webforms/capture.php" name="Contact Form" action="" method="post"
	    ...
	    <div class="form-inner__item">
	        <div class="form-inner__item--full">
	            ...
	            <select name="cf_1085" class="clear_form" onchange="yesnoCheckCon(this);" required>
	                ...
	                <option class="elements" value="Congo, The Democratic Republic of The">Congo, The Democratic Republic
	                    of The</option>
	                ...
	                <option class="elements" value="Heard Island and Mcdonald Islands">Heard Island and Mcdonald Islands
	                </option>
	                ...
	                <option class="elements" value="Korea, Democratic People's Republic of">Korea, Democratic People's
	                    Republic of</option>
	                ...
	                <option class="elements" value="Lao People's Democratic Republic">Lao People's Democratic Republic
	                </option>
	                ...
	                <option class="elements" value="Saint Vincent and The Grenadines">Saint Vincent and The Grenadines
	                </option>
	                ...
	                <option class="elements" value="South Georgia and The South Sandwich Islands">South Georgia and The
	                ...
	                <option class="elements" value="United Kingdom">United Kingdom</option>
	                <option class="elements" value="United States">United States</option>
	                <option class="elements" value="United States Minor Outlying Islands">United States Minor Outlying
	                    Islands</option>
	    ...
	    <div id="ifYesCon" class="form-inner__item" style="display: none;">
	        <div class="form-inner__item--full">
	            ...
	            <select id="state_required" class="clear_form" class="invalid error" name="cf_1093">
	                ...
	                <option class="canadian_province elements" value="Newfoundland and Labrador">Newfoundland and Labrador
	                </option>
