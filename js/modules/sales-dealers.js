jQuery(function ($) {
  ...
  $(".chosen-select").change(function (code, val) {
    ...
    selcont = $(this.options[this.selectedIndex])
      .closest("optgroup")
      .prop("label");
    if (selcont == "Europe") {
      loadEuropeMap();
  ...
  function loadWorldMap() {
    ...
    $(".profiles-list .profile-list__item").addClass("hide");
    $("#map").html("");
    ...
    gvworld = $("#map").vectorMap({
      ...
      markers: [
        { latLng: [19.9, -72.45], name: "Caribbean Islands" },
        { latLng: [11.9, -84.0], name: "Central America" },
      ],
  ...
  function loadEuropeMap() {
    ...
    $(".profiles").addClass("visible");

    $(".gv-border").css("border-color", "#3c89c9");
    $("#tm-content")
      .removeClass()
      .addClass("tm-content")
      .addClass("gv-europe-reg");
    $(".profiles-list .profile-list__item").each(function (index, element) {
    ...
    $("#map").vectorMap({
      ...
      onRegionClick: function (event, code) {
        ...
        if (
          ...
          $(".profiles-list .profile-list__item").each(function (
            index,
            element
          ) {
            continent = $(this).attr("data-continent").split(",");
  ...
  function loadCaribbeanMap() {
    ...
    $("#map").vectorMap({
      ...
      markers: [{ latLng: [19.9, -72.45], name: "Caribbean Islands" }],
      markerStyle: {
        initial: {
          fill: "#af0000",
          stroke: "#af0000",
  ...
  $(".profile-list__item .more-info").on("click", function (e) {
    if ($(this).hasClass("active")) {
      $(this).removeClass("active").next(".more-content").slideUp("active");
      $(this).text("More info");
    } else {
      $(".profile-list__item").find(".more-content").slideUp();
      $(this).addClass("active").next(".more-content").slideDown("active");
      $(this).text("Hide info");
    }
  });

  // navigation regions
  document.getElementById("gv-world").addEventListener(
    "click",
    function () {
      delete thereg;
      loadWorldMap();
  ...
  document.getElementById("gv-southa").addEventListener(
    "click",
    function () {
      delete thereg;
      $(".chosen-select").val("").trigger("chosen:updated");
  ...
  document.getElementById("gv-caribbean").addEventListener(
    "click",
    function () {
      delete thereg;
      $(".chosen-select").val("").trigger("chosen:updated");
  ...
  document.getElementById("gv-europe").addEventListener(
    "click",
    function () {
      delete thereg;
      $(".chosen-select").val("").trigger("chosen:updated");
  ...
  document.getElementById("gv-northa").addEventListener(
    "click",
    function () {
      delete thereg;
      $(".chosen-select").val("").trigger("chosen:updated");
  ...
  document.getElementById("gv-northa1").addEventListener(
    "click",
    function () {
      delete thereg;
      $(".chosen-select").val("").trigger("chosen:updated");
  ...
  document.getElementById("gv-africa").addEventListener(
    "click",
    function () {
      delete thereg;
      $(".chosen-select").val("").trigger("chosen:updated");
  ...
  document.getElementById("gv-oceania").addEventListener(
    "click",
    function () {
      delete thereg;
      $(".chosen-select").val("").trigger("chosen:updated");
  ...
  document.getElementById("gv-asia").addEventListener(
    "click",
    function () {
      delete thereg;
      $(".chosen-select").val("").trigger("chosen:updated");
  ...
  document.getElementById("gv-centrala").addEventListener(
    "click",
    function () {
      delete thereg;
      $(".chosen-select").val("").trigger("chosen:updated");
