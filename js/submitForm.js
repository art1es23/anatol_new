function submitForm(formID) {
  ...
  const inputs = Array.from(document.querySelectorAll("input")).filter(
    (item) => !item.classList.contains("submit-btn")
  );
  ...
  vtigerForm.forEach((item) =>
    item.addEventListener("submit", (e) => {
      ...
      postData(
        "https://vtiger.anatol.com/modules/Webforms/capture.php",
        formData
      )
        .then((response) => {})
        .catch((error) => {})
      ...
      function translate_kurul(formm) {
      ...
      function translate_kurul_sub(formm) {
        // let formm = document.querySelector(a);
        formm.firstname.value = url_slug(formm.firstname.value);
        formm.lastname.value = url_slug(formm.lastname.value);
      }
