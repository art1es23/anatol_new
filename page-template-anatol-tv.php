...
<section class="anatol-videos" id="anatol_videos">
    <div class="anatol-videos--wrapper container">
        ...
        <div class="anatol-videos-list--wrapper">
            ...
            <div class="anatol-videos-tab-content list-videos">
...
let element_class = document.querySelectorAll('.tab-pane');

list_tbs[0].classList.add('active');
element_class[0].classList.add('active');
element_class[0].classList.add('active_active');

// arrayTabsTrigger.forEach(item =>
//     item.addEventListener('click', e => {
//         e.preventDefault();

//         arrayTabsTrigger.forEach(child => child.classList.remove('active'));
//         arrayTabsContent.forEach(child => child.classList.remove('active'));
